...
namespace EmployeeManagement.Test
{
    ...
    {
        [Fact]
        public void EmployeeFullNamePropertyGetter_InputFirstNameAndLastName_FullNameIsConcatination()
        {
            // Arrange
        ...
        [Fact]
        public void EmployeeFullNamePropertyGetter_InputFirstNameAndLastName_FullNameMatchesWithRegularExpressions()
        {
            // Arrange
            var employee = new InternalEmployee("Kevin", "Dockx", 0, 2500, false, 1);
